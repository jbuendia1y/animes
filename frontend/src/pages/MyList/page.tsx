...
import { AnimeCard, Footer, Navbar } from "../../components";
...
export function MyList() {
  ...
  const [{ list: data, loading }, setData] = useState<{
    list: { anime: Anime; userId: string; id: string }[] | null;
    loading: boolean;
  }>({
    list: null,
    loading: true,
  ...
  const { changeTotalItems, totalPages, currentPage, changePage } = usePaginate(
    {
      totalItems: 1,
  ...
  }, [user, changeTotalItems, currentPage]);
